...
- `/status` แสดงเพิ่ม 3 บรรทัดจาก Pi Brain: ผู้ใช้ (อีเมลหรือผู้เยี่ยมชม) · ฐานความรู้ (จำนวนรายการ + ที่สอนในเบราว์เซอร์นี้) · ตารางภายใน (เชื่อมแล้วกี่ตาราง และมาจาก `local` หรือ `railway` / ยังไม่ได้เชื่อม / มีรหัสแต่เชื่อมไม่ได้) — บรรทัด "ปลายทาง CRM/SaaS (เฟสถัดไป)" คือ endpoint ของ `/connect` ไม่เกี่ยวกับตาราง
