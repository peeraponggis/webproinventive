...
- **FAQ ที่สอนไว้แล้วใน `tools/faq_extra.json` (5 รายการ, 3 ก.ย. 2569)** — คำถาม sizing แบบไม่มีตัวเลข ซึ่ง skill คำนวณจับไม่ได้: วิธีคำนวณจำนวนแผง/ขนาดระบบ · ขนาดแบตเตอรี่ควรเป็นเท่าไหร่ (อ้าง วสท. 022013-25 ข้อ 5.3.2 (3)) · 1 kWp ผลิตได้เท่าไหร่ในไทย · เลือกขนาดอินเวอร์เตอร์ (DC/AC ratio) · ต้องใช้พื้นที่หลังคาเท่าไหร่ — ทุกรายการมี TH/EN และเป็นสูตร/ค่าประมาณของเราเอง ไม่ใช่เนื้อหาลิขสิทธิ์
