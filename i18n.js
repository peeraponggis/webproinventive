...
(function (global) {
    ...
    var DICT = {
        th: {
            ...
            "kb.estimate": "สูตรประมาณการของ PROINVENTIVE (ไม่ใช่ค่าจากมาตรฐาน)",
            "kb.alsoNote": "ข้อควรรู้:",
            "kb.teachNoSuch": "ไม่มีรายการหมายเลข {n} (มีอยู่ {total} รายการ) — ดูหมายเลขจาก /teach list",
            "kb.status.user": "ผู้ใช้: {user}",
            "kb.status.guest": "ผู้เยี่ยมชม (ยังไม่เข้าสู่ระบบ)",
            "kb.status.kb": "ฐานความรู้: {n} รายการ + สอนในเบราว์เซอร์นี้ {taught} รายการ",
            "kb.status.kbFail": "ฐานความรู้: โหลดไม่สำเร็จ",
            "kb.status.tablesGuest": "ตารางภายใน: เฉพาะพนักงาน (เข้าสู่ระบบแล้วใช้ /tables <รหัส>)",
            "kb.status.tablesOk": "ตารางภายใน: เชื่อมแล้ว {n} ตาราง ({src})",
            "kb.status.tablesNone": "ตารางภายใน: ยังไม่ได้เชื่อม — ใส่รหัสด้วย /tables <รหัส>",
            "kb.status.tablesFail": "ตารางภายใน: มีรหัสแต่เชื่อมไม่ได้ — ตรวจรหัสหรือเซิร์ฟเวอร์ (/tables)",
            "kb.ref": "อ้างอิง",
            "kb.clause": "ข้อ",
            ...
            "pi.status.msg": "สถานะปัจจุบัน: {status}\nปลายทาง CRM/SaaS (เฟสถัดไป): {endpoint}\nภาษา: {lang}",
        ...
        en: {
            ...
            "kb.estimate": "PROINVENTIVE rule-of-thumb estimate (not a value from the standard)",
            "kb.alsoNote": "Also note:",
            "kb.teachNoSuch": "There is no entry number {n} ({total} entries exist) — check the numbers with /teach list",
            "kb.status.user": "User: {user}",
            "kb.status.guest": "visitor (not signed in)",
            "kb.status.kb": "Knowledge base: {n} entries + {taught} taught in this browser",
            "kb.status.kbFail": "Knowledge base: failed to load",
            "kb.status.tablesGuest": "Internal tables: staff only (sign in, then /tables <key>)",
            "kb.status.tablesOk": "Internal tables: connected, {n} tables ({src})",
            "kb.status.tablesNone": "Internal tables: not connected — enter the key with /tables <key>",
            "kb.status.tablesFail": "Internal tables: key present but connection failed — check the key or server (/tables)",
            "kb.ref": "Reference",
            "kb.clause": "clause",
            ...
            "pi.status.msg": "Current status: {status}\nCRM/SaaS endpoint (next phase): {endpoint}\nLanguage: {lang}",
